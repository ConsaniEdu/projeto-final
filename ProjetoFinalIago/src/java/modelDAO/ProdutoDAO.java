...
public class ProdutoDAO {
    ...
    public void cadastrarProduto(ProdutoDTO objProdutoDTO){
        ...
        try {
            ...
            objProdutoDTO.setNome_produto(objProdutoDTO.getNome_produto());
            objProdutoDTO.setDescricao(objProdutoDTO.getDescricao());
            objProdutoDTO.setPreco(objProdutoDTO.getPreco());
            objProdutoDTO.setQuantidade(objProdutoDTO.getQuantidade());
    ...
    public List<ProdutoDTO> listarProdutos(){
        ...
        try {
            ...
            while(rs.next()){
                ...
                objProdutoDTO.setImagem(rs.getByte("imagem"));
